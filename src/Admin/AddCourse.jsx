      ...
      <div className="">
        <div className="card border-0">
          <div className="card-header bg-secondary text-center p-4">
            <h1 className="text-white m-0">ADD COURSE  Details</h1>
          </div>
          <div className="card-body rounded-bottom bg-primary p-5">
            <form>
              <div className="form-group">
                <label> Course Name</label>
                <input type="text" className="form-control border-0 p-4" placeholder="Course Name" required="required" />
              </div>
              ...
              <div className="form-group">
                ...
                <input type="textarea" className="form-control border-0 p-4" placeholder="Your Course Description" required="required" />
              </div>
